            ...
            <>
                ...
                <main className="mx-auto max-w-7xl px-4">
                    <div className="prose max-w-none py-6">
                        ...
                        <p>
                            For now, the only extension made is a user script
                            for Chrome (requires{' '}
                            ...
                            or equivalent) (untested in other browsers). You can
                            always find{' '}
                        ...
                        <p>
                            The source code for the script and its issue tracker
                            can be found{' '}
                        ...
                        <p>
                            Finally, for broader discussions about the
                            extension, please come visit{' '}
                        ...
                        <img
                            src={s}
                            alt="Screenshot of the userscript in action"
                        />
                    </div>
                </main>
            </>
