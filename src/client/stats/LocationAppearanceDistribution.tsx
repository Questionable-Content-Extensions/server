            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        callbacks: {
                            label: (ctx) =>
                                `${(ctx.parsed.y as number).toLocaleString()} locations`,
                        },
                    },
                },
                scales: {
...
export default function LocationAppearanceDistribution({
    locationsData,
    locationsError,
}: Props) {
    ...
    const total = locationsData?.length ?? 0;
    ...
    return (
        <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
                Histogram of locations by their total appearance count. Shows
                how many locations are one-timers vs. recurring settings. Total:{' '}
                ...
                <StatsTable>
                    <thead>
                        <StatsTheadRow>
                            ...
                            <StaticHeader align="right">Locations</StaticHeader>
