    ...
    return (
        <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
                ...
                compared to their career average per year. The ratio shows how
                exceptional that year was — a ratio of 3× means they appeared
                three times more than usual. When multiple years tie for the
                best count, all are listed. Only characters with appearances in
                at least 2 years are included.
            </p>
