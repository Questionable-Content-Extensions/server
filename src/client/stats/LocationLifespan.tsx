    ...
    return (
        <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
                Every location ranked by how long it has been in use, measured
                as the comic-number span between its first and last appearance.
                A wide span with few appearances indicates a location used only
                occasionally over a long period.
            </p>
