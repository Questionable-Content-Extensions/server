    ...
    return (
        <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
                ...
                members share a comic with this character on average (excluding
                themselves). A low value means the character tends to appear
                alone or in very small scenes. Only characters with at least 10
